    ...
    def __init__(self, dilation_series, padding_series, NoLabels):
        ...
        for dilation, padding in zip(dilation_series, padding_series):
            self.conv2d_list.append(
                nn.Conv2d(2048, NoLabels, kernel_size=3, stride=1, padding=padding-1, dilation=dilation, bias=True))
...
class ResNet(nn.Module):
    def __init__(self, block, layers, NoLabels):
        ...
        self.blocks = list()
        self.blocks.append(nn.Sequential(self.conv1,
                                    self.bn1,
                                    self.relu,
                                    self.maxpool))
        self.blocks.append(self.layer1)
        self.blocks.append(self.layer2)
        self.blocks.append(self.layer3)
        self.blocks.append(self.layer4)
        self.blocks.append(self.layer5)
        self.blocks.append(self.upsample)
    ...
    def forward(self, x):
        return nn.Sequential(*self.blocks)(x), None
